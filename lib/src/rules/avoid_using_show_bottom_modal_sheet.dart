...
class AvoidUsingShowBottomModalSheet extends Rule {
  ...
  static const ruleId = 'avoid-using-show-bottom-modal-sheet';
  static const code = ruleId;
  static const methodName = 'showModalBottomSheet';
  static const comment = '快速添加';
  static const message = '禁止使用原生$methodName方法';
  static const correction = '原生$methodName函数禁止调用';

  AvoidUsingShowBottomModalSheet(this._compilationUnit, this.analysisResult) {
